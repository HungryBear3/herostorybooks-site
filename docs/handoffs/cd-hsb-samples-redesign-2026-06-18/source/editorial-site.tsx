...
const kindDragonSample = {
  ...
  status: 'Current replaceable website sample',
  ...
  return (
    <section className="bg-[#fff8ec]/45 pt-4 pb-20 md:pt-6 md:pb-20">
      <div className="mx-auto max-w-6xl px-5 md:px-8">
        <SectionHeader eyebrow="Website sample" title="One finished proof packet, shown clearly." sub="The sample art below comes from a completed Lukas digital proof packet. It is shown as an illustrative website sample, and newer proof packets can replace it when they are materially stronger." />
        <KindDragonFeature compact />
        <div className="mt-12">
      ...
      <div className="grid gap-7 lg:grid-cols-[0.92fr_1.08fr]">
        <div>
          <div className="mb-4 flex flex-wrap gap-2">
            <span className="rounded-full border border-[#d8c6a2] bg-[#f5ead2] px-3 py-1 text-[10px] font-bold uppercase tracking-[0.18em] text-[#695f54]">{kindDragonSample.status}</span>
            <span className="rounded-full bg-[#1f1a16] px-3 py-1 text-[10px] font-bold uppercase tracking-[0.18em] text-[#fff8ec]">{kindDragonSample.framing}</span>
          </div>
          <figure className="overflow-hidden rounded-2xl border border-[#d8c6a2] bg-[#f5ead2]">
            <img
              src={kindDragonSample.cover}
              alt="Digital sample cover for Lukas and the Kind Dragon"
          ...
          <a href={kindDragonSample.contactSheet} className="mt-4 inline-flex text-sm font-semibold text-[#a64c4c] underline-offset-4 hover:underline">
            Open the full contact sheet
          </a>
        </div>
        <div>
          <div className="mb-5">
            <div className="text-[11px] font-bold uppercase tracking-[0.24em] text-[#a64c4c]">{kindDragonSample.source}</div>
            <h3 className="mt-2 font-serif text-4xl font-medium leading-tight text-[#1f1a16]">Lukas and the Kind Dragon</h3>
            <p className="mt-3 text-base leading-7 text-[#695f54]">
              A kindness-first adventure with family moments, Brody, and a shy dragon. Current baseline: v5 contrast packet, approved for website sample use with this illustrative framing.
            </p>
          </div>
          <div className="grid gap-4 sm:grid-cols-2">
            {kindDragonSample.pages.slice(0, compact ? 4 : kindDragonSample.pages.length).map((page) => (
...
export function EditorialSamplesPage() {
  return (
    <EditorialPageShell active="sample">
      <section className="mx-auto max-w-6xl px-5 py-16 md:px-8 md:py-24">
        <SectionHeader eyebrow="Sample" title="A peek inside a personalized proof book." sub="This page uses the Lukas / Kind Dragon v5 proof packet as the current website sample. It is a digital sample for illustration only; every new paid book still receives its own proof and approval pass before delivery or print." centered />
        <KindDragonFeature />
        <div className="mt-14">
          <HardcoverPhotoSection />
        </div>
        <div className="mt-14">
          <SectionHeader eyebrow="Previous print proof" title="Earlier dinosaur sample." sub="This older Lukas dinosaur material remains here as supporting proof history, while Kind Dragon is the current replaceable website sample." />
        </div>
