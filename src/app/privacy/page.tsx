    ...
    <EditorialPageShell>
      <section className="mx-auto max-w-3xl px-5 py-16 md:px-8 md:py-24">
        ...
        <div className="mt-10 space-y-7 text-base leading-8 text-[#695f54]">
          ...
          <section><h2 className="font-serif text-2xl text-[#1f1a16]">Children&apos;s information</h2><p className="mt-2">HeroStoryBooks is purchased by adults; we do not market to children, and we do not knowingly collect information directly from children. Orders must be placed by a parent, guardian, or authorized adult. Child details, uploaded photos, guided reference photos, and optional voice notes are used only to make the requested book and provide customer support. We do not sell children&apos;s data or use uploaded photos, guided reference photos, or voice notes to train our own AI models. We handle uploaded child photos and optional voice notes with care consistent with COPPA principles.</p></section>
          <section><h2 className="font-serif text-2xl text-[#1f1a16]">How we use AI and vendors</h2><p className="mt-2">We may use trusted service providers for AI-assisted illustration/story drafting, hosting, email delivery, payment processing, and print fulfillment. We share only what is needed for those services to complete your order. Some providers may temporarily process or store order inputs to provide, secure, troubleshoot, or comply with the service.</p></section>
          <section><h2 className="font-serif text-2xl text-[#1f1a16]">Retention and deletion</h2><p className="mt-2">We retain order records as needed for fulfillment, support, fraud prevention, tax/accounting, and legal obligations. Uploaded child photos, guided reference photos, and optional voice notes are kept only as long as needed to create, proof, fulfill, and support your order, subject to legal record-keeping obligations. You can request deletion of uploaded child photos, guided reference photos, or optional voice files by emailing support@herostorybooks.com.</p></section>
