    ...
    <EditorialPageShell>
      <section className="mx-auto max-w-3xl px-5 py-16 md:px-8 md:py-24">
        ...
        <div className="mt-10 space-y-7 text-base leading-8 text-[#695f54]">
          ...
          <section><h2 className="font-serif text-2xl text-[#1f1a16]">Retention and deletion</h2><p className="mt-2">We retain order records as needed for fulfillment, support, fraud prevention, tax/accounting, and legal obligations. You can request deletion of uploaded child photos or optional voice files by emailing support@herostorybooks.com.</p></section>
