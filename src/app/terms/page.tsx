    ...
    <EditorialPageShell>
      <section className="mx-auto max-w-3xl px-5 py-16 md:px-8 md:py-24">
        ...
        <div className="mt-10 space-y-7 text-base leading-8 text-[#695f54]">
          ...
          <section><h2 className="font-serif text-2xl text-[#1f1a16]">Revisions and refunds</h2><p className="mt-2">If something in the proof feels wrong, contact us before approval and we will revise it. Because each book is personalized, approved printed orders generally cannot be canceled once submitted to print fulfillment. If there is a production defect or fulfillment error, email us and we will make it right.</p></section>
