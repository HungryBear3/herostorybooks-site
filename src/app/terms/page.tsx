    ...
    <EditorialPageShell>
      <section className="mx-auto max-w-3xl px-5 py-16 md:px-8 md:py-24">
        ...
        <div className="mt-10 space-y-7 text-base leading-8 text-[#695f54]">
          ...
          <section><h2 className="font-serif text-2xl text-[#1f1a16]">Acceptable uploads and media use</h2><p className="mt-2">Do not upload content you do not have rights or permission to use, or content that is abusive, explicit, unlawful, unsafe, or invasive of another person&apos;s privacy. Uploaded photos, voice notes, memory recordings, and documents are used only to create, proof, fulfill, and support your requested book. We do <strong>not</strong> use uploaded media for voice cloning, public publishing, or AI model training. We may refuse or cancel orders that violate these terms.</p><p className="mt-2">You may request deletion of uploaded photos, voice files, or documents by emailing support@herostorybooks.com. Deletion may be limited by completed fulfillment, backups, fraud prevention, accounting, dispute, or legal record-keeping requirements.</p></section>
