...
export const PHOTO_UPLOAD_HELP =
  "Required before production starts — optional before payment. You can place the order now and add the photo later, but we cannot start your proof until this clear, well-lit child photo is added. Large phone photos are automatically reduced when we can.";
