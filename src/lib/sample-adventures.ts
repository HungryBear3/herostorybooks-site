...
export const SAMPLE_ADVENTURES: SampleAdventure[] = [
  {
    ...
    pages: [
      ...
      },
      {
        ...
        story: "As Marcus pushed through the thick vines, stone walls covered in mysterious symbols appeared. His eyes grew wide with wonder. Could this be the legendary Lost City? Each careful step brought him closer to solving the ancient mystery.",
      },
      {
        subtitle: 'Page 3 - Hidden Map',
        sceneTitle: 'A Clue Hidden in the Moss',
        sceneAccent: 'from-emerald-700 via-green-600 to-yellow-500',
        story: "Behind a curtain of vines, Marcus found a weathered stone map etched with glowing paths. He traced the markings with his fingertips and realized the treasure chamber was deeper in the ruins than anyone had imagined.",
      },
      {
        subtitle: 'Page 4 - The Treasure Chamber',
        sceneTitle: 'The Golden Chamber',
        sceneAccent: 'from-yellow-500 via-amber-400 to-orange-400',
        story: "A golden doorway opened into a chamber filled with artifacts, murals, and sparkling light. Marcus took a deep breath, remembered to stay brave, and stepped inside to make the discovery of a lifetime.",
      },
      {
